...
When you click the **Knit** button a document will be generated that includes both content as well as the output of any embemydataed R code chunks within the document. You can embed an R code chunk like this:

################################ mixed effects model #############################
```{r log}
mydata <- read.table(here('data', 'mocksoup_longtable.txt'), header = T)
mydata <- mydata %>% filter(readNum != 0)
